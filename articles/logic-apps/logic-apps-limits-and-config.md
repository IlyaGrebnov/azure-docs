...
|Name|Limit|Notes|
|----|----|----|
|Actions executions per second (burst)|1000|Can distribute workflows across multiple apps as needed|
|Actions executions per hour (sustained)|1,000,000|Can distribute workflows across multiple apps as needed|
